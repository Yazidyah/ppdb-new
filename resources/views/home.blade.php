...
<section>
    <div class="container flex justify-center  mx-auto gap-2">
        ...
        <div class="md:w-[20vw] p-6 bg-primary border border-gray-200 rounded-lg shadow-sm  dark:border-white">
            ...
            <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-tertiary rounded-lg hover:bg-secondary focus:ring-4 focus:outline-none focus:ring-blue-300 hover:text-tertiary">
                Read more
        ...
        <div class="md:w-[20vw] p-6 bg-primary border border-gray-200 rounded-lg shadow-sm  dark:border-white">
            ...
            <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-tertiary rounded-lg hover:text-tertiary hover:bg-secondary focus:ring-4 focus:outline-none focus:ring-blue-300">
                Read more
                <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
                </svg>
