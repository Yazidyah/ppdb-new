...
<<<<<<< HEAD
    ...
    <div class="w-1/2 p-6 bg-primary border justify-center items-center flex flex-col border-gray-200 rounded-lg shadow-sm  dark:border-white">
        ...
        <div class="md:w-[20vw] p-6 bg-primary border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-white">
            ...
            <a href="/siswa/daftar-step-satu?t=1" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-primary bg-secondary rounded-lg hover:text-white hover:bg-tertiary focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
    ...
    <div class="w-1/2 p-6 bg-primary border justify-center items-center flex flex-col border-gray-200 rounded-lg shadow-sm  dark:border-white">
            ...
            <a href="/siswa/daftar-step-satu" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-primary bg-secondary rounded-lg hover:bg-tertiary focus:ring-4 focus:outline-none focus:ring-blue-300 hover:text-white ">
