...
<section>
    ...
    <div class="md:w-[20vw] p-6 bg-primary border border-gray-200 rounded-lg shadow-sm  dark:border-white">
            ...
            <a href="/siswa/daftar-step1" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-primary bg-secondary rounded-lg hover:bg-tertiary focus:ring-4 focus:outline-none focus:ring-blue-300 hover:text-white ">
                Read more
