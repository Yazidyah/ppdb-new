...
<head>
    ...
    })(window,document,'script','dataLayer','GTM-KPD66ZGG');</script>
    ...
    <meta property="og:title" content="PMBM MAN 1 Kota Bogor">
    ...
    <meta name="twitter:title" content="PMBM MAN 1 Kota Bogor">
...
<body class="font-sans text-gray-900 antialiased">
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KPD66ZGG"
    ...
    <div
        ...
        <div class="relative z-10">
            <a href="/" class="flex flex-col justify-center items-center">
                ...
                <h1 class="text-3xl text-white font-bold text-center mt-4">PMBM MAN 1 Kota Bogor</h1>
            </a>
        </div>

        <div class="relative z-10 w-full sm:max-w-md mt-6 px-8 py-8 bg-white shadow-2xl overflow-hidden sm:rounded-2xl border border-gray-100">
            {{ $slot }}
        </div>
    </div>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-EN9QFV83H0"></script>
    <script>
