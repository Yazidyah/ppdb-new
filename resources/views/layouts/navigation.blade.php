...
<nav x-data="{ open: false }" class="sticky top-0 z-50 bg-tertiary mx-auto w-full right-0 left-0">
    ...
    <div class="flex justify-between items-center container mx-auto">
        ...
        <div class="flex">
            ...
            <!-- Settings Dropdown -->
            <div class="py-4 pl-6 pr-8 lg:flex hidden gap-4">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center  border border-transparent  leading-4 bg-dasar  focus:outline-none transition ease-in-out duration-150 hover:bg-white text-white outline-dasar outline px-7 py-3 rounded-full font-bold text-xs xl:text-base hover:text-tertiary ">
                            <img src="/logoman.webp" class="w-5">
                            <div class="text-base ml-2" x-data="{{ json_encode(['name' => auth()->user()->name]) }}" x-text="name"
