        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
                    ...
                    <form method="GET" action="{{ route('operator.datasiswa') }}" class="mb-4 flex justify-between"
                        ...
                        <div>
                            <select name="filter" class="px-4 py-2 border rounded-lg"
                                ...
                                <option value="" {{ !request('filter') ? 'selected' : '' }}>Tidak ada filter
                                    status
                                </option>
                                ...
                                <option value="7" {{ request('filter') == '8' ? 'selected' : '' }}>Dicadangkan
                                </option>
                            </select>
                            ...
                            <tbody>
                                @forelse ($data as $siswa)
                                    ...
                                    <tr class="hover:bg-gray-200 transition duration-200 cursor-pointer">
                                        ...
                                        <td scope="col" class="px-6 py-3 text-center">
                                            <button onclick="openModalStatus({{ $siswa->id_calon_siswa }})"
                                                class="px-4 py-2 bg-tertiary text-white font-medium rounded-lg hover:bg-secondary hover:text-tertiary">Update</button>
                                        </td>
                                    </tr>
                                    @empty
                                        <tr>
            ...
            {{-- <div id="verifModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
                <div class="bg-white p-6 rounded-lg">
                    ...
                    <form method="POST" action="{{ route('operator.updateVerifStatus') }}" id="statusForm"
                        class="mt-4">
                        @csrf
                    ...
                    <div class="flex justify-end mt-4">
                        <button type="button" onclick="closeModalVerif()"
            ...
            <script>
                ...
                `;
                        ...
                        dokumenTableBody.innerHTML =
                            `<tr><td colspan="4" class="border px-4 py-2 text-center">Tidak ada dokumen</td></tr>`;
                    }
