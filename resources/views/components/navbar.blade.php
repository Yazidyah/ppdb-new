<div class=" bg-primary mx-auto w-full sticky z-10 top-0 right-0 left-0">
        ...
        <nav class="flex justify-between items-center container mx-auto">
            ...
            <div class="items-center flex">
                ...
                <div class="py-4 pl-6 lg:flex hidden gap-4">
                    <a href="login"  class="text-white outline-secondary outline px-7  flex items-center justify-center rounded-full font-bold text-xs xl:text-base hover:bg-white hover:text-primary ">Masuk</a>
                    <a href="register" class=" flex items-center justify-center w-full text-sm font-bold px-9 py-4 bg-white rounded-full hover:bg-secondary hover:text-primary text-primary" >Daftar</a>
            </div>
        ...
        <div class="mobileMenu hidden xl:hidden">
            ...
            <div  class="py-4 px-3 cursor-pointer hover:bg-white text-white hover:text-primary focus-scale-95 transition-all duration-200 ease-out p-2 relative text-sm text-center font-bold" x-data="{dropdown:false}">
                    <button @click="dropdown = !dropdown" class=" focus-scale-95 transition-all duration-200 ease-out p-2 rounded-lg " >Daftar</button>
                    <!--DropDown-->
                    <div class=" bg-secondary z-10 text-primary rounded-md right-0 my-2 p-2" x-show="dropdown" @click.outside="dropdown = false">
                        <ul class="space-y-2 w-full">
                        <li><a href="register" class="flex p-2 font-medium text-primary rounded-md hover:bg-white hover:text-black">Anggota Khalansa</a></li>
