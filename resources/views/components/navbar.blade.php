<div class="bg-tertiary mx-auto w-full sticky top-0 right-0 left-0 shadow-md" style="z-index: 9999; position: sticky;">
    <nav class="flex justify-between items-center container mx-auto">
        <div class=" flex items-center gap-2 md:gap-4 justify-start px-3 py-2 md:py-0 min-w-0">
                ...
                <h1 class="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-white font-poppins truncate">PPDB MAN 1 Kota Bogor</h1>
        </div>
        ...
        <button class="py-2 px-3 md:py-4 md:px-6 lg:hidden block buttonDown text-white flex-shrink-0">
            <svg class="w-9 h-9 md:w-12 md:h-12" viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="mobileMenu hidden lg:hidden pb-4">
