...
<div class="w-[20vw] p-6 bg-primary border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-white">
    ...
    <a href="/daftar/step3/prestasi" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-primary bg-secondary rounded-lg hover:bg-tertiary focus:ring-4 focus:outline-none focus:ring-blue-300 hover:text-white dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Pilih Jalur Ini
...
<div class="w-[20vw] p-6 bg-primary border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-white">
    ...
    <a href="/daftar/step3/KETM" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-primary bg-secondary rounded-lg hover:text-white hover:bg-tertiary focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Pilih Jalur Ini
        <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
        </svg>
...
<div class="w-[20vw] p-6 bg-primary border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-white">
    ...
    <a href="/daftar/step3/AnakBerkemampuanKhusus" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-primary bg-secondary rounded-lg hover:text-white hover:bg-tertiary focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Pilih Jalur Ini
        <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
        </svg>
