<div class="flex">
    ...
    <div class="w-64 bg-tertiary text-white h-screen fixed top-0 left-0 overflow-y-auto">
        <div class="p-6 mt-[80px]">
            <nav>
                <ul>
                    <li class="mb-2">
                        <a href="#statistics" class="block px-4 py-2 bg-primary rounded hover:bg-primary">Dashboard</a>
                    </li>
                    <li class="mb-2">
                        <a href="#gender" class="block px-4 py-2 hover:bg-primary">Testing</a>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <div class="ml-64 p-10">
        ...
        <div class="bg-gray-100 py-10 w-[1460px] " id="statistics">
