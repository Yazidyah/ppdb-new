<div>
    ...
    <div class="flex justify-center bg-gray-100 py-10 p-14">
        @foreach ($statistik->take(5) as $stat)
            <div class="container mx-auto pr-4">
                <div
                    class="w-75  bg-white max-w-xs mx-auto rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition duration-500 transform scale-100 hover:scale-110 cursor-pointer">
                    <div class="h-20 bg-tertiary flex items-center justify-between">
    ...
    <div class="flex justify-center bg-gray-100 py-10 p-5">
        ...
        <div class="container mr-5 rounded-lg ml-2 mx-auto bg-white shadow-xl">
                ...
                <div class="bg-white my-6">
                    <table class="text-left w-full border-collapse">
                        <thead>
                            <tr>
                                <th
                                    class="py-4 px-6 bg-secondary font-bold uppercase text-sm  text-tertiary border-b border-grey-light">
                                    JENIS KELAMIN</th>
                                <th
                                    class="py-4 px-6 text-center bg-secondary font-bold uppercase text-sm text-tertiary border-b border-grey-light">
                                    JUMLAH</th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="container mr-5 rounded-lg mx-auto bg-white shadow-xl">
            <div class="w-11/12 mx-auto">
                <div class="bg-white my-6">
                    <table class="text-left w-full border-collapse">
                        <thead>
