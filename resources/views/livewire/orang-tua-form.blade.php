            ...
            <div class="items-center justify-center col-span-3">
                <div
                    ...
                    <x-reg-input-text id="nik"
                        class="block flex-1 border-0 bg-transparent py-1.5 px-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 w-full"
                        type="tel" name="nik" wire:model.live="nik" placeholder="NIK" inputmode="numeric" pattern="[0-9]*" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="16" />
                    @error('nik')
                        <span class="text-xs text-red-500 flex items-center mx-1">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="items-center justify-center col-span-3">
                <div
                    ...
                    <x-reg-input-text id="no_telp"
                        class="block flex-1 border-0 bg-transparent py-1.5 px-3 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 w-full"
                        type="tel" name="no_telp" wire:model.live="no_telp" placeholder="Nomor Telepon" inputmode="numeric" pattern="[0-9]*" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="15"/>
                    @error('no_telp')
                        <span class="text-xs text-red-500 flex items-center mx-1">{{ $message }}</span>
                    @enderror
                </div>
