<div class="p-8 bg-white rounded-lg">
            ...
            <div class="bg-white rounded-lg shadow-2xl w-3/4 max-w-5xl mt-[600px] border border-gray-300">
                ...
                <div class="p-4">
                    ...
                    <iframe src="{{ $previewUrlKartuPeserta }}"
                        class="w-full rounded-lg h-[700px] border rounded"></iframe>
                    @else
    ...
    <div class="grid grid-cols-2 gap-4 text-gray-700 text-left ">
        <div class="border p-4 rounded-lg bg-green-50">
            ...
            <div class="col-span-1 row-span-2 grid grid-cols-2 gap-4">
                <div>
                    <label class="text-xs font-medium">Nama Lengkap</label>
                    <input type="text" wire:model="nama_lengkap"
                        class="border p-2 w-full rounded-lg w-full focus:border-tertiary  focus:ring-tertiary shadow-sm">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" wire:model="alamat_domisili"
                        class="border p-2 w-full rounded-lg focus:border-tertiary  focus:ring-tertiary shadow-sm">
                </div>
                <div>
                    <label class="text-xs font-medium">Alamat KK</label>
                    <input type="text" wire:model="alamat_kk"
                        class="border p-2 w-full rounded-lg focus:border-tertiary  focus:ring-tertiary shadow-sm">
                </div>
                <div>
            ...
            <div class="border p-4 rounded-lg mb-4 bg-green-50">
                ...
                <div class="col-start-2 row-start-1 grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="sekolah_asal"
                            class="border p-2 w-full rounded-lg focus:border-tertiary  focus:ring-tertiary shadow-sm">
                    </div>
                    <div>
        ...
        <div class="border p-4 rounded-lg col-span-2 bg-green-50">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" wire:model="jadwalTesBQ"
                        class="border p-2 w-full rounded-lg focus:border-tertiary  focus:ring-tertiary shadow-sm">
                </div>
                <div>
                    <label class="text-xs font-medium">Seleksi Japres</label>
                    <input type="text" wire:model="jadwalTesJapres"
                        class="border p-2 w-full rounded-lg focus:border-tertiary  focus:ring-tertiary shadow-sm">
                </div>
            </div>
        </div>
