<div>
    ...
    <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm z-50" wire:click="$set('modalOpen', false)">
        <div class="w-3/4 h-[90vh] bg-white rounded-lg p-6 transition duration-300 ease-in-out transform overflow-y-auto" wire:click.stop>
