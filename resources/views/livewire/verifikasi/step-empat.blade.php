            ...
            <div class="relative p-6 bg-white rounded-lg shadow md:p-10">
                ...
                <div class="mb-6 text-base font-light text-gray-500">
                    ...
                    <p class="text-xl">
                        ...
                        merupakan dokumen yang sah, valid, dan memuat informasi yang akurat sesuai dengan kondisi
                        sebenarnya. Saya juga bersedia untuk mempertanggungjawabkan keabsahan serta kebenaran data yang
                        tercantum di dalam dokumen tersebut sesuai dengan peraturan dan standar yang berlaku.
                    </p>
                </div>
