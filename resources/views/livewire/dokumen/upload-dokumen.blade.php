        ...
        <div class="md:grid flex flex-col grid-cols-4 grid-rows-2 gap-8  w-full">
            ...
            <div class="flex flex-col  col-span-1 row-span-1 ">
                ...
                <div class="flex items-center justify-center w-full h-full">
                    <label for="tipe_dokumen" class="flex flex-col items-center justify-center w-full h-full border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-tertiary text-white hover:text-tertiary  hover:bg-secondary ">
                ...
                <p id="tipe_dokumen" onchange="handleFileUpload(event, 'tipe_dokumen')" class="text-sm text-black mt-2">Belum ada file</p>
                <div>
                    <button type="button" onclick="showExample('{{$data->nama_persyaratan}}')" class="mt-2 px-4 py-2 bg-tertiary hover:bg-secondary hover:text-tertiary text-white rounded-lg">Lihat Contoh</button>
