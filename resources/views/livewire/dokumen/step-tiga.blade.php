                                        ...
                                        <div
                                                ...
                                                <div class="sm:flex sm:items-start">
                                                    ...
                                                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                        <h3 class="text-base font-medium leading-6 text-gray-900"
                                                            id="modal-title">
                                                            Verifikasi Pendaftaran</h3>
                                                        <div>
                                                        </div>
                                                        <div class="mt-2">
                                                            <p class="text-sm text-gray-500">
                                                                Pastikan data yang diinputkan sudah benar, proses ini
                                                                akan
                                                                diteruskan ke pendaftar berupa pengumuman.
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="px-4 py-3 bg-gray-50 sm:flex sm:flex-row-reverse sm:px-6">
                                                <button type="button" wire:click="kirim"
                                                    class="inline-flex justify-center w-full px-8 py-2 text-sm font-medium text-white bg-green-600 rounded-md shadow-sm hover:bg-green-500 sm:ml-3 sm:w-auto">
                                                    Verifikasi</button>
