<div id="rapotModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white p-6 rounded-lg shadow-lg w-1/2">
        <div class="flex justify-end">
            <button onclick="document.getElementById('rapotModal').style.display='none'"
        ...
        <div class="">
            <div class="flex flex-row justify-center lg:justify-between px-4 sm:px-40 items-center mx-auto bg-secondary">
                <div onclick="goToStep(0)"
                    class="step-indicator w-16 h-16 sm:w-24 sm:h-24 rounded-xl flex flex-col items-center justify-center {{ request()->is('showStep(currentStep)') ? 'bg-tertiary text-white' : '' }}">
                    <a href="javascript:void(0)"
                        class="bg-white rounded-full items-center justify-center flex w-8 h-8 sm:w-12 sm:h-12">
                        <h1 class="font-bold text-primary text-center text-sm sm:text-3xl">1</h1>
                    </a>
                    <a href="javascript:void(0)" class="text-[8px] md:text-[13px]">
                        <h1 class="font-semibold flex text-center">Semester 1</h1>
                    </a>
                </div>
                <div onclick="goToStep(1)"
                    class="step-indicator w-16 h-16 sm:w-24 sm:h-24 rounded-xl flex flex-col items-center justify-center {{ request()->is('showStep(currentStep)') ? 'bg-tertiary text-tertiary' : '' }}">
                    <a href="javascript:void(0)"
                        class="bg-white rounded-full items-center justify-center flex w-8 h-8 sm:w-12 sm:h-12">
                        <h1 class="font-bold text-primary text-center text-sm sm:text-3xl">2</h1>
                    </a>
                    <a href="javascript:void(0)" class="text-[8px] md:text-[13px]">
                        <h1 class="font-semibold flex text-center">Semester 2</h1>
                    </a>
                </div>
                <div onclick="goToStep(2)"
                    ...
                    <a href="javascript:void(0)" class="text-[8px] md:text-[13px]">
                        <h1 class="font-semibold flex text-center">Semester 3</h1>
                    </a>
                </div>
                <div onclick="goToStep(3)"
                    ...
                    <a href="javascript:void(0)" class="text-[8px] md:text-[13px]">
                        <h1 class="font-semibold flex text-center">Semester 4</h1>
                    </a>
                </div>
                <div onclick="goToStep(4)"
                    ...
                    <a href="javascript:void(0)" class="text-[8px] md:text-[13px]">
                        <h1 class="font-semibold flex text-center">Semester 5</h1>
                    </a>
                </div>
            </div>
                ...
                <form method="post" action="{{ route('register') }}" id="multiStepForm" enctype="multipart/form-data">
                    ...
                    <div class="steps">
                        ...
                        <div>
                            ...
                            <x-text-input class="bg-white" id="bahasaindo" class="block mt-1 w-full" type="text"
                                name="bahasaindo" :value="old('bahasaindo')" required autofocus autocomplete="bahasaindo" />
                            <x-input-error :messages="$errors->get('bahasaindo')" class="mt-2" />
                        </div>
                        <div>
                            <x-input-label for="bahasainggris" :value="__('Bahasa Inggris')" />
                            <x-text-input class="bg-white" id="bahasainggris" class="block mt-1 w-full" type="text"
                                name="bahasainggris" :value="old('bahasainggris')" required autofocus
                                autocomplete="bahasainggris" />
                        ...
                        <div>
                            ...
                            <x-text-input class="bg-white" id="ipa" class="block mt-1 w-full " type="text"
                                name="ipa" :value="old('ipa')" required autofocus autocomplete="ipa" />
                            <x-input-error :messages="$errors->get('ipa')" class="mt-2" />
                        </div>
                        <div>
                            <x-input-label for="ips" :value="__('IPS')" />
                            <x-text-input class="bg-white" id="ips" class="block mt-1 w-full" type="text"
                                name="ips" :value="old('ips')" required autofocus autocomplete="ips" />
                    ...
                    <div class="steps hidden">
                        ...
                        <div>
                            <x-input-label for="bahasainggris" :value="__('Bahasa Inggris')" />
                            <x-text-input class="bg-white" id="bahasainggris" class="block mt-1 w-full"
                                type="text" name="bahasainggris" :value="old('bahasainggris')" required autofocus
                                autocomplete="bahasainggris" />
                            <x-input-error :messages="$errors->get('bahasainggris')" class="mt-2" />
                        </div>
                        <div>
