<div>
    ...
    <div class="md:grid-row-2 flex flex-col md:grid-cols-1 md:grid gap-x-4 gap-y-1">
        <div class="md:w-full md:h-full p-6 bg-primary border border-gray-200 rounded-lg shadow-sm ">
            ...
            <a href="javascript:void(0)" wire:click="updateJalur({{ $jalur->id_jalur }})" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-primary bg-secondary rounded-lg hover:bg-tertiary focus:ring-4 focus:outline-none focus:ring-blue-300 hover:text-white ">
                Pilih Jalur Ini
